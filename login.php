...
<body>
    ...
    <main class="hero d-flex">
        ...
        <div class="left-section">
            <div class="leftsection" style="margin-top: 40px; margin-left: 100px; width: 500px">
                <img src="./bakj-removebg-preview.png" alt="" />
            </div>
        </div>
                <!-- right section -->
            ...
            <form action="" method="POST">
                <div class="container bg-light" style="border-radius: 10px">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-6 w-100">
                            <div class="form-group name">
                                <label for="file" style="cursor: pointer">Phone No:</label>
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-primary mt-3 mb-2" id="submit" name="sumbit">
                            Log in
                        </button>
                    </div>
