...
<body>
    ...
    <div class="container mt-5" style="height: 100px; width: 800px;">
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Account Login Sucessfull</h4>
   ...
   <!-- <hr class="hr"> -->
    <table class="table table-bordered  shadow-lg bg-opacity-75">
        ...
        <tbody>
            ...
            $sql = "SELECT  `name`, `phone`, `email`,  `account_num` FROM `register`  limit 1 ";
            $query = mysqli_query($con, $sql);
            // $n=mysqli_num_rows($query);
            // echo "$n";
